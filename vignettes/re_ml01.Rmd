...
4.1 Why is the difference between the evaluation of the KNN model in the training and test sets greater than that of the linear regression model?
...
4.2 Why does KNN perform better than linear regression on the test set?
...
4.3 How to locate KNN and Linear Regression in the bias-variance trade-off framework?
